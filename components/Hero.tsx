          ...
          {/* Trust Signals */}
            ...
            <div className="relative inline-flex items-center gap-2 px-3 py-1.5 rounded-full shadow-sm" style={{ backgroundColor: '#ADC8A6', borderColor: '#2A4049', border: '1px solid' }}>
              ...
              <span className="text-xs font-semibold text-black">Leading Hospitals</span>
                ...
                {/* Right: hero image */}
        <div className="relative z-10 w-full mt-4 md:w-7/12 md:absolute md:right-0 md:bottom-0 md:h-full md:flex md:items-end md:overflow-hidden md:pt-16 md:mt-0">
          <Image
            priority
            ...
            width={1200}
            height={1200}
                className="w-full h-auto max-h-[300px] md:max-h-[520px] md:w-full md:h-full md:object-contain md:object-right md:object-bottom md:scale-110"
          />
        </div>
      </div>
    </section>
